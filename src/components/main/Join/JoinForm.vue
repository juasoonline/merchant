              ...
              <div class="border border-gray-200 rounded">
                  ...
                  <div v-if="step1.status === false" class="px-5 mb-5">
                      <form class="text-xs" @submit.prevent="createBusiness">
                              ...
                              <!-- Begin business name -->
                              <div class="mt-3">
                                  <label class="text-gray-500 text-xs">Business Name</label>
                                  <div class="flex mt-1">
                                      ...
                                      <input type="text" v-model="businessInfo.store_name" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter business name">
                                  </div>
                              </div>
                              <!-- End business name -->
                              ...
                              <!-- Begin region -->
                              <div class="mt-3">
                                  <label class="text-gray-500 text-xs">Select Region</label>
                                  <div class="flex mt-1">
                                      <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                      ...
                                      <select v-model="businessInfo.region" class="appearance-none border rounded-r px-3 py-2 w-full focus:outline-none">
                              ...
                              <!-- Begin city -->
                              <div class="mt-3">
                                  <label class="text-gray-500 text-xs">Business City</label>
                                  <div class="flex mt-1">
                                      <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                      ...
                                      <input type="text" v-model="businessInfo.city" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter business city">
                                  </div>
                              </div>
                              <!-- End city -->
                              ...
                              <!-- Begin address -->
                              <div class="mt-3">
                                  <label class="text-gray-500 text-xs">Business Address</label>
                                  <div class="flex mt-1">
                                      <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                      ...
                                      <input type="text" v-model="businessInfo.address" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter business address">
                                  </div>
                              </div>
                              <!-- End address -->
                              ...
                              <!-- Begin postal code -->
                              <div class="mt-3">
                                  <label class="text-gray-500 text-xs">Ghana Post Code</label>
                                  <div class="flex mt-1">
                                      <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                      ...
                                      <input type="text" v-model="businessInfo.postal_code" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter business GPS code">
                                  </div>
                              </div>
                              <!-- End postal code -->
                              ...
                              <!-- Begin primary phone -->
                              <div class="mt-3">
                                  <label class="text-gray-500 text-xs">Business Primary Phone</label>
                                  <div class="flex mt-1">
                                      <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                      ...
                                      <input type="text" v-model="businessInfo.mobile_phone" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter business primary phone">
                                  </div>
                              </div>
                              <!-- End primary phone -->
                              ...
                              <div class="mt-3">
                                  <label class="text-gray-500 text-xs">Business Secondary Phone</label>
                                  <div class="flex mt-1">
                                      <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                      ...
                                      <input type="text" v-model="businessInfo.other_phone" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter business secondary phone">
                                  </div>
                              </div>
                              <!-- End secondary phone -->
                              ...
                              <!-- Begin web address -->
                              <div class="mt-3">
                                  <label class="text-gray-500 text-xs">Business Website</label>
                                  <div class="flex mt-1">
                                      <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                      ...
                                      <input type="email" v-model="businessInfo.website" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter business website address">
                                  </div>
                              </div>
                              <!-- End email -->
                              ...
                              <!-- Begin email -->
                              <div class="mt-3">
                                  <label class="text-gray-500 text-xs">Business Email Address</label>
                                  <div class="flex mt-1">
                                      <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                      ...
                                      <input type="email" v-model="businessInfo.email" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter business email address">
                                  </div>
                              </div>
                              <!-- End email -->
                              ...
                              <div class="mt-6">
                                  <div class="flex mt-3">
                                      <button type="button" @click="createBusiness" class="rounded bg-juaso-primary text-white font-bold px-3 py-2 w-full focus:outline-none hover:bg-juaso-secondary">Continue</button>
                                  </div>
                              </div>
                              <!-- End submit button -->
                      ...
                      <form class="text-xs" @submit.prevent="createAdmin">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="text" v-model="storeAdminInfo.first_name" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter first name">
                            </div>
                        </div>
                        <!-- End first name -->
                        ...
                        <!-- Begin other names -->
                        <div class="mt-3">
                            <label class="text-gray-500 text-xs">Other Names</label>
                            <div class="flex mt-1">
                                <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                    <svg class="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd"></path><path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z"></path></svg>
                                </div>
                                <input type="text" v-model="storeAdminInfo.other_names" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter other names">
                            </div>
                        </div>
                        <!-- End other names -->
                        ...
                        <div class="mt-3">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="text" v-model="storeAdminInfo.last_name" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter last name">
                            </div>
                        </div>
                        <!-- End last name -->
                        ...
                        <!-- Begin designation -->
                        <div class="mt-3">
                            <label class="text-gray-500 text-xs">Designation / Position</label>
                            <div class="flex mt-1">
                                <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                    <svg class="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd"></path><path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z"></path></svg>
                                </div>
                                <input type="text" v-model="storeAdminInfo.designation" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter designation">
                            </div>
                        </div>
                        <!-- End designation -->
                        ...
                        <!-- Begin mobile phone -->
                        <div class="mt-3">
                            <label class="text-gray-500 text-xs">Mobile Phone</label>
                            <div class="flex mt-1">
                                <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                    <svg class="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd"></path><path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z"></path></svg>
                                </div>
                                <input type="text" v-model="storeAdminInfo.mobile_phone" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter mobile phone">
                            </div>
                        </div>
                        <!-- End mobile phone -->
                        ...
                        <!-- Begin office phone -->
                        <div class="mt-3">
                            <label class="text-gray-500 text-xs">Office Phone</label>
                            <div class="flex mt-1">
                                <div class="w-12 z-10 text-center pointer-events-none flex items-center justify-center border-l border-t border-b rounded-l bg-gray-100">
                                    <svg class="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd"></path><path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z"></path></svg>
                                </div>
                                <input type="text" v-model="storeAdminInfo.office_phone" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter office phone">
                            </div>
                        </div>
                        <!-- End office phone -->
                        ...
                        <div class="mt-2">
                            ...
                            <div class="flex mt-2">
                                ...
                                <input type="email" required v-model="storeAdminInfo.email" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter email address">
                            </div>
                        </div>
                        <!-- End email -->
                        ...
                        <div class="mt-5">
                            ...
                            <div class="flex mt-2">
                                ...
                                <input type="password" required v-model="storeAdminInfo.password" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter password">
                            </div>
                        </div>
                        <!-- End password -->
                        ...
                        <div class="mt-5">
                            ...
                            <div class="flex mt-2">
                                ...
                                <input type="password" required v-model="storeAdminInfo.password_confirmation" class="border rounded-r px-3 py-2 w-full focus:outline-none" placeholder="Enter password again">
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            <div class="flex mt-3">
                                <button type="button" @click="createAdmin" class="rounded bg-juaso-primary text-white font-bold px-3 py-2 w-full focus:outline-none hover:bg-juaso-secondary">Continue</button>
                            </div>
                        </div>
                        <!-- End submit button -->
        ...
        setup()
        {
            ...
            const createBusiness = () => {
                axios( { method: 'POST', url: 'stores', headers: {}, data: { data: { type: "Store", attributes: { store_name: businessInfo.value.store_name, region: businessInfo.value.region, city: businessInfo.value.city, address: businessInfo.value.address, postal_code: businessInfo.value.postal_code, mobile_phone: businessInfo.value.mobile_phone, other_phone: businessInfo.value.other_phone, email: businessInfo.value.email, website: businessInfo.value.website } } } })
                    .then( response => { if ( response.data.status === "Success" ){ storeAdminInfo.value.store_id = response.data.data.id; step1.value.status = true; step1.value.class = "wizard-success"; step2.value.class = "wizard-active" } else { console.log( "Error occurred" ) } } )
            ...
            return { businessInfo, storeAdminInfo, createBusiness, createAdmin, step1, step2, step3 }
        }
    }
</script>
