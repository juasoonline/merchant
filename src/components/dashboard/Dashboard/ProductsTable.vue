...
<script>
    ...
    export default
    {
        ...
        setup()
        {
            ...
            onBeforeMount( () =>
            {
                axios({ method: 'GET', url: 'store/' + authentication.state.user.include.store.attributes.resource_id + '/products', headers: { 'Authorization': 'Bearer ' + authentication.state.token } })
                    .then( response =>
                    {
