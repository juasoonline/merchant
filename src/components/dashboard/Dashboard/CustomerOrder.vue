    ...
    <section class="px-6 mb-5">
        <div class="flex grid grid-cols-2 gap-3">
            ...
            <div class="bg-white rounded p-5">
                <h2 class="font-bold text-gray-600">Customers</h2>
                                        ...
                                        <tr>
                                            <td class="py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-4">
                                                        <div class="text-sm font-medium text-gray-900">Michael Katey Kabutey</div>
                                                        <div class="flex text-sm text-gray-500 items-center">
                                                            <svg class="w-3.5 h-3.5 mr-0.5 -ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                                            <span class="text-xs">Adenta - Accra</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-500">465</div>
            ...
            <!-- Begin orders -->
            <div class="bg-white rounded p-5">
                <h2 class="font-bold text-gray-600">Recent Orders</h2>
